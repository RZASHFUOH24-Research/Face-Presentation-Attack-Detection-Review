...
We present a comprehensive review of recent deep learning methods for face Presentation Attack Detection (fPAD). It covers hybrid (handcrafted+deep), end-to-end deep learning, and generalised learning based methods for RGB fPAD. It also presents detailed comparision among publicly available datasets, together with several classical evaluation protocols.
...
- [Datasets](#data)
  - [Using RGB camera](#data_RGB)
- [Deep Learning](#methods_RGB)
  - [Hybrid Methods](#hybrid)
  - [Binary cross-entropy supervision](#binary)
...
### 2️⃣ Deep FAS methods with RGB camera
